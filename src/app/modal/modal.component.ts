...
export class ModalComponent implements OnInit {
  imageList: string[] = [
    ...
    // Add URLs for the other 14 images here
  ];
  selectedImages: boolean[] = new Array(15).fill(false);
  ...
  saveImages() {
    const selectedImageUrls = this.imageList.filter((_, index) => this.selectedImages[index]);
